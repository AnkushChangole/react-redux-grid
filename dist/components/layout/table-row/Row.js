...
var addEmptyInsert = exports.addEmptyInsert = function addEmptyInsert(cells, visibleColumns, plugins, id) {

    if (visibleColumns.length === 0) {

        if (plugins && plugins.GRID_ACTIONS && plugins.GRID_ACTIONS.menu && plugins.GRID_ACTIONS.menu.length > 0) {
            cells.splice(1, 0, _react2.default.createElement(_EmptyCell.EmptyCell, { key: id + '-Grid-Action' }));
        } else {
            cells.push(_react2.default.createElement(_EmptyCell.EmptyCell, { key: id + '-Empty-Cell' }));
        }
    }
